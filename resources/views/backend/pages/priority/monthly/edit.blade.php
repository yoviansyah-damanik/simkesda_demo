    ...
    <div class="container">
        ...
        <form action="" method="post">
                                ...
                                <div class="form-group">
                                    <label for="sumber_data" class="form-label form-label-bold">
                                        ...
                                        <p class="small helper">
                                            Sumber Tempalate Prioritas - Data Bulanan diperoleh.
                                        </p>
                                    </label>
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <select name="bulan" id="bulan" class="form-select" required>
                                        ...
                                        @for ($x = 1; $x <= 12; $x++)
                                            <option value="{{ $x }}"
                                                @if (old('bulan', $data->bulan) == $x) selected @endif>
            ...
            <div class="scrollable-side">
                <div class="content">
                    <h2 class="main-title">Data Bulanan</h2>
                            ...
                            <div class="row border-bottom py-2">
                                ...
                                <div class="col-md-6 col-lg-4 mt-2 mt-lg-0 d-flex">
                                    <input type="number"
                                        ...
                                        value="{{ old(${'atts_' . $z}[$x]['attribute'], $data->{${'atts_' . $z}[$x]['attribute']}) }}"
                                        required>
                                    <select class="form-select ms-1" name="{{ ${'atts_' . $z}[$x]['satuan'] }}"
                                        ...
                                        @foreach (${'atts_' . $z}[$x]['select'] as $val)
                                            <option value="{{ $val }}"
                                                @if (old(${'atts_' . $z}[$x]['satuan'], $data->{${'atts_' . $z}[$x]['satuan']}) == $val) selected @endif>
                                                {{ $val }}
                                            </option>
                                        @endforeach
                                    </select>
