                ...
                <div class="content">
                        ...
                        <div class="col-lg-4 devide-right">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('nama_puskesmas') is-invalid @enderror"
                                    ...
                                    value="{{ old('nama_puskesmas', $data->nama_puskesmas) }}" required>
                            </div>
                            <div class="form-group">
                                ...
                                <select name="jenis_puskesmas" id="jenis_puskesmas" class="form-control selectpicker"
                                    required>
                                    <option value="" disabled selected>--Pilih Jenis Puskesmas--</option>
                                    @foreach ($jenis_puskesmas as $val)
                                        <option value="{{ $val }}"
                                            @if ($val == old('jenis_puskesmas', $data->jenis_puskesmas)) selected @endif>
                        ...
                        <div class="col-lg-4 mt-4 mt-lg-0 devide-right">
                            ...
                            <div class="form-group">
                                ...
                                <input type="hidden" name="nama_provinsi" id="nama_provinsi"
                                    value="{{ old('nama_provinsi', $data->province->name) }}">
                                <select name="id_provinsi" id="id_provinsi"
                                    class="form-control selectpicker @error('id_provinsi') is-invalid @enderror" required>
                                    <option value="{{ old('id_provinsi', $data->id_provinsi) }}">
                                        {{ old('nama_provinsi', $data->province->name) }}
                                    </option>
                                </select>
                            </div>
                            <div class="form-group">
                                ...
                                <input type="hidden" name="nama_kabupaten" id="nama_kabupaten"
                                    value="{{ old('nama_kabupaten', $data->regency->name) }}">
                                <select name="id_kabupaten" id="id_kabupaten"
                                    class="form-control selectpicker @error('id_kabupaten') is-invalid @enderror" required>
                                    <option value="{{ old('id_kabupaten', $data->id_kabupaten) }}">
                                        {{ old('nama_kabupaten', $data->regency->name) }}
                                    </option>
                                </select>
                            </div>
                            <div class="form-group">
                                ...
                                <input type="hidden" name="nama_kecamatan" id="nama_kecamatan"
                                    value="{{ old('nama_kecamatan', $data->district->name) }}">
                                <select name="id_kecamatan" id="id_kecamatan"
                                    class="form-control selectpicker @error('id_kecamatan') is-invalid @enderror" required>
                                    <option value="{{ old('id_kecamatan', $data->id_kecamatan) }}">
                                        {{ old('nama_kecamatan', $data->district->name) }}
                                    </option>
                                </select>
                            </div>
                            <div class="form-group">
                                ...
                                <input type="hidden" name="nama_desa" id="nama_desa"
                                    value="{{ old('nama_desa', $data->village->name) }}">
                                <select name="id_desa" id="id_desa"
                                    class="form-control selectpicker @error('id_desa') is-invalid @enderror" required>
                                    <option value="{{ old('id_desa', $data->id_desa) }}">
                                        {{ old('nama_desa', $data->village->name) }}
                                    </option>
                                </select>
                            </div>
                            <div class="form-group">
                                ...
                                <textarea class="form-control @error('alamat_puskesmas') is-invalid @enderror" id="alamat_puskesmas"
                                    name="alamat_puskesmas" required>{{ old('alamat_puskesmas', $data->alamat_puskesmas) }}</textarea>
                            </div>
                            <div class="form-group">
                        ...
                        <div class="col-lg-4 mt-4 mt-lg-0">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="nomor_telp" id="nomor_telp"
                                    ...
                                    value="{{ old('nomor_telp', $data->nomor_telp) }}" required>
                            </div>
                            <div class="form-group">
                                ...
                                <input type="text" name="nomor_fax" id="nomor_fax"
                                    ...
                                    value="{{ old('nomor_fax', $data->nomor_fax) }}">
                            </div>
                            <div class="form-group">
                                ...
                                <input type="email" name="email_puskesmas" id="email_puskesmas"
                                    ...
                                    value="{{ old('email_puskesmas', $data->email_puskesmas) }}" required>
                            </div>
                            <div class="form-group">
                                ...
                                <input type="text" name="nama_kontak" id="nama_kontak"
                                    ...
                                    value="{{ old('nama_kontak', $data->nama_kontak) }}" required>
                            </div>
                            <div class="form-group">
                                ...
                                <input type="number" name="telp_kontak" id="telp_kontak"
                                    ...
                                    value="{{ old('telp_kontak', $data->telp_kontak) }}" required>
                            </div>
                            <div class="form-group">
                                ...
                                <input type="email" name="email_kontak" id="email_kontak"
                                    ...
                                    value="{{ old('email_kontak', $data->email_kontak) }}" required>
                            </div>
                        </div>
                    </div>
                    <hr>
                    ...
                    <div class="row" id="karakteristik-puskesmas">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-3">
                                    <input type="number"
                                        ...
                                        value="{{ old('luas_wilayah', $data->luas_wilayah) }}" required>
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-3">
                                    <input type="number" class="form-control @error('jml_desa') is-invalid @enderror"
                                        id="jml_desa" name="jml_desa" value="{{ old('jml_desa', $data->jml_desa) }}"
                                        required>
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-3">
                                    <input type="number" class="form-control @error('jml_kk') is-invalid @enderror"
                                        id="jml_kk" name="jml_kk" value="{{ old('jml_kk', $data->jml_kk) }}"
                                        required>
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-3">
                                    <input type="number"
                                        ...
                                        id="jml_penduduk" name="jml_penduduk"
                                        value="{{ old('jml_penduduk', $data->jml_penduduk) }}" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 mt-4 mt-lg-0">
                            ...
                            <input type="hidden" id="kriteria_puskesmas">
                            @foreach ($kriteria_puskesmas as $val)
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="kriteria_puskesmas"
                                        ...
                                        @if (old('kriteria_puskesmas', $data->kriteria_puskesmas) == $val) checked @endif required>
                    ...
                    <div class="row" id="kondisi-puskesmas">
                        ...
                        <div class="col-lg-6 devide-right">
                            <div class="form-group">
                                ...
                                <select name="keadaan_bangunan" id="keadaan_bangunan" class="form-control selectpicker"
                                    required>
                                    <option value="" disabled selected>--Pilih Keadaan Bangunan--</option>
                                    @foreach ($keadaan_bangunan as $val)
                                        @if ($val == old('keadaan_bangunan', $data->keadaan_bangunan))
                        ...
                        <div class="col-lg-6 mt-4 mt-lg-0">
                            <div class="form-group">
                                ...
                                <select name="status_akreditasi" id="status_akreditasi" class="form-control selectpicker"
                                    required>
                                    <option value="" disabled selected>--Pilih Status Akreditasi--</option>
                                    @foreach ($akreditasi as $val)
                                        @if ($val == old('status_akreditasi', $data->status_akreditasi))
                                            <option value="{{ $val }}" selected>{{ $val }}</option>
                                        @else
                                            <option value="{{ $val }}">{{ $val }}</option>
                                        @endif
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-3">
                                    <input type="number" class="form-control @error('jml_dk') is-invalid @enderror"
                                        id="jml_dk" name="jml_dk" value="{{ old('jml_dk', $data->jml_dk) }}"
                                        required>
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-3">
                                    <input type="number" class="form-control @error('jml_dk_gigi') is-invalid @enderror"
                                        id="jml_dk_gigi" name="jml_dk_gigi"
                                        value="{{ old('jml_dk_gigi', $data->jml_dk_gigi) }}" required>
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-3">
                                    <input type="number" class="form-control @error('jml_perawat') is-invalid @enderror"
                                        id="jml_perawat" name="jml_perawat"
                                        value="{{ old('jml_perawat', $data->jml_perawat) }}" required>
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-3">
                                    <input type="number" class="form-control @error('jml_bidan') is-invalid @enderror"
                                        id="jml_bidan" name="jml_bidan" value="{{ old('jml_bidan', $data->jml_bidan) }}"
                                        required>
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-3">
                                    <input type="number"
                                        ...
                                        value="{{ old('jml_tk_masyarakat', $data->jml_tk_masyarakat) }}" required>
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-3">
                                    <input type="number"
                                        ...
                                        value="{{ old('jml_tk_lingkungan', $data->jml_tk_lingkungan) }}" required>
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-3">
                                    <input type="number"
                                        ...
                                        id="jml_tenaga_gizi" name="jml_tenaga_gizi"
                                        value="{{ old('jml_tenaga_gizi', $data->jml_tenaga_gizi) }}" required>
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-3">
                                    <input type="number"
                                        ...
                                        value="{{ old('jml_ahli_tek_medik', $data->jml_ahli_tek_medik) }}" required>
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-3">
                                    <input type="number" class="form-control @error('jml_farmasi') is-invalid @enderror"
                                        id="jml_farmasi" name="jml_farmasi"
                                        value="{{ old('jml_farmasi', $data->jml_farmasi) }}" required>
                                </div>
                            </div>
                            <hr class="line">
                            <div class="row mb-3">
                                ...
                                <div class="col-3">
                                    <input type="number"
                                        ...
                                        value="{{ old('jml_tenaga_kesehatan', $data->jml_tenaga_kesehatan) }}" required>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-3">
                                    <input type="number"
                                        ...
                                        value="{{ old('jml_tenaga_penunjang', $data->jml_tenaga_penunjang) }}" required>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-3">
                                    <input type="number"
                                        ...
                                        value="{{ old('jml_tenaga_puskesmas', $data->jml_tenaga_puskesmas) }}" required>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-3">
                                    <input type="number"
                                        ...
                                        id="ambulance_baik" name="ambulance_baik"
                                        value="{{ old('ambulance_baik', $data->ambulance_baik) }}" required>
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-3">
                                    <input type="number"
                                        ...
                                        value="{{ old('ambulance_rusak_ringan', $data->ambulance_rusak_ringan) }}"
                                        required>
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-3">
                                    <input type="number"
                                        ...
                                        value="{{ old('ambulance_rusak_berat', $data->ambulance_rusak_berat) }}" required>
                                </div>
                            </div>
                            <hr class="line">
                            <div class="row mb-3">
                                ...
                                <div class="col-3">
                                    <input type="number"
                                        ...
                                        id="jml_ambulance" name="jml_ambulance"
                                        value="{{ old('jml_ambulance', $data->jml_ambulance) }}" required>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-3">
                                    <input type="number" class="form-control @error('motor_baik') is-invalid @enderror"
                                        id="motor_baik" name="motor_baik"
                                        value="{{ old('motor_baik', $data->motor_baik) }}" required>
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-3">
                                    <input type="number"
                                        ...
                                        value="{{ old('motor_rusak_ringan', $data->motor_rusak_ringan) }}" required>
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-3">
                                    <input type="number"
                                        ...
                                        value="{{ old('motor_rusak_berat', $data->motor_rusak_berat) }}" required>
                                </div>
                            </div>
                            <hr class="line">
                            <div class="row mb-3">
                                ...
                                <div class="col-3">
                                    <input type="number" class="form-control @error('jml_motor') is-invalid @enderror"
                                        id="jml_motor" name="jml_motor" value="{{ old('jml_motor', $data->jml_motor) }}"
                                        required>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-3">
                                    <input type="number"
                                        ...
                                        id="pusling_baik" name="pusling_baik"
                                        value="{{ old('pusling_baik', $data->pusling_baik) }}" required>
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-3">
                                    <input type="number"
                                        ...
                                        value="{{ old('pusling_rusak_ringan', $data->pusling_rusak_ringan) }}" required>
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-3">
                                    <input type="number"
                                        ...
                                        value="{{ old('pusling_rusak_berat', $data->pusling_rusak_berat) }}" required>
                                </div>
                            </div>
                            <hr class="line">
                            <div class="row mb-3">
                                ...
                                <div class="col-3">
                                    <input type="number" class="form-control @error('jml_pusling') is-invalid @enderror"
                                        id="jml_pusling" name="jml_pusling"
                                        value="{{ old('jml_pusling', $data->jml_pusling) }}" required>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-3">
                                    <input type="number"
                                        ...
                                        value="{{ old('pusling_perairan_baik', $data->pusling_perairan_baik) }}" required>
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-3">
                                    <input type="number"
                                        ...
                                        value="{{ old('pusling_perairan_rusak_ringan', $data->pusling_perairan_rusak_ringan) }}"
                                        required>
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-3">
                                    <input type="number"
                                        ...
                                        value="{{ old('pusling_perairan_rusak_berat', $data->pusling_perairan_rusak_berat) }}"
                                        required>
                                </div>
                            </div>
                            <hr class="line">
                            <div class="row mb-3">
                                ...
                                <div class="col-3">
                                    <input type="number"
                                        ...
                                        value="{{ old('jml_pusling_perairan', $data->jml_pusling_perairan) }}" required>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-3">
                                    <input type="number" class="form-control @error('pustu_baik') is-invalid @enderror"
                                        id="pustu_baik" name="pustu_baik"
                                        value="{{ old('pustu_baik', $data->pustu_baik) }}" required>
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-3">
                                    <input type="number"
                                        ...
                                        value="{{ old('pustu_rusak_ringan', $data->pustu_rusak_ringan) }}" required>
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-3">
                                    <input type="number"
                                        ...
                                        value="{{ old('pustu_rusak_sedang', $data->pustu_rusak_sedang) }}" required>
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-3">
                                    <input type="number"
                                        ...
                                        value="{{ old('pustu_rusak_berat', $data->pustu_rusak_berat) }}" required>
                                </div>
                            </div>
                            <hr class="line">
                            <div class="row mb-3">
                                ...
                                <div class="col-3">
                                    <input type="number" class="form-control @error('jml_pustu') is-invalid @enderror"
                                        id="jml_pustu" name="jml_pustu" value="{{ old('jml_pustu', $data->jml_pustu) }}"
                                        required>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-3">
                                    <input type="number"
                                        ...
                                        value="{{ old('rumdis_nakes_baik', $data->rumdis_nakes_baik) }}" required>
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-3">
                                    <input type="number"
                                        ...
                                        value="{{ old('rumdis_nakes_rusak_ringan', $data->rumdis_nakes_rusak_ringan) }}"
                                        required>
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-3">
                                    <input type="number"
                                        ...
                                        value="{{ old('rumdis_nakes_rusak_sedang', $data->rumdis_nakes_rusak_sedang) }}"
                                        required>
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-3">
                                    <input type="number"
                                        ...
                                        value="{{ old('rumdis_nakes_rusak_berat', $data->rumdis_nakes_rusak_berat) }}"
                                        required>
                                </div>
                            </div>
                            <hr class="line">
                            <div class="row mb-3">
                                ...
                                <div class="col-3">
                                    <input type="number"
                                        ...
                                        value="{{ old('jml_rumdis_nakes', $data->jml_rumdis_nakes) }}" required>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-3">
                                    <input type="number"
                                        ...
                                        id="jml_poskesdes" name="jml_poskesdes"
                                        value="{{ old('jml_poskesdes', $data->jml_poskesdes) }}" required>
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-3">
                                    <input type="number"
                                        ...
                                        id="jml_poskestren" name="jml_poskestren"
                                        value="{{ old('jml_poskestren', $data->jml_poskestren) }}" required>
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-3">
                                    <input type="number"
                                        ...
                                        value="{{ old('jml_posyandu_lansia', $data->jml_posyandu_lansia) }}" required>
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-3">
                                    <input type="number"
                                        ...
                                        value="{{ old('jml_posbindu_ptm_aktif', $data->jml_posbindu_ptm_aktif) }}"
                                        required>
                                </div>
                            </div>
                            <hr class="line">
                            <div class="row mb-3">
                                ...
                                <div class="col-3">
                                    <input type="number" class="form-control @error('jml_ukbm') is-invalid @enderror"
                                        id="jml_ukbm" name="jml_ukbm" value="{{ old('jml_ukbm', $data->jml_ukbm) }}"
                                        required>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-3">
                                    <input type="number"
                                        ...
                                        value="{{ old('jml_posyandu_pratama', $data->jml_posyandu_pratama) }}" required>
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-3">
                                    <input type="number"
                                        ...
                                        value="{{ old('jml_posyandu_madya', $data->jml_posyandu_madya) }}" required>
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-3">
                                    <input type="number"
                                        ...
                                        value="{{ old('jml_posyandu_purnama', $data->jml_posyandu_purnama) }}" required>
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-3">
                                    <input type="number"
                                        ...
                                        value="{{ old('jml_posyandu_mandiri', $data->jml_posyandu_mandiri) }}" required>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-3">
                                    <input type="number"
                                        ...
                                        id="jml_posyandu" name="jml_posyandu"
                                        value="{{ old('jml_posyandu', $data->jml_posyandu) }}" required>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-3">
                                    <input type="number"
                                        ...
                                        value="{{ old('jml_ukbm_posyandu', $data->jml_ukbm_posyandu) }}" required>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row" id="sarana-puskesmas">
                        ...
                        <div class="col-lg-4 devide-right">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-3">
                                    <input type="number"
                                        ...
                                        value="{{ old('jml_tt_perawatan_umum', $data->jml_tt_perawatan_umum) }}" required>
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-3">
                                    <input type="number"
                                        ...
                                        value="{{ old('jml_tt_perawatan_persalinan', $data->jml_tt_perawatan_persalinan) }}"
                                        required>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ old('nama_aplikasi_pencatatan', $data->nama_aplikasi_pencatatan) }}"
                            ...
                            <div class="form-group">
                                ...
                                <select name="waktu_ketersediaan_listrik" id="waktu_ketersediaan_listrik"
                                    ...
                                    @foreach ($waktu_ketersediaan_listrik as $val)
                                        @if ($val == old('waktu_ketersediaan_listrik', $data->waktu_ketersediaan_listrik))
                                            <option value="{{ $val }}" selected>{{ $val }}</option>
                                        @else
                                            <option value="{{ $val }}">{{ $val }}</option>
                                        @endif
                            ...
                            <div class="form-group">
                                ...
                                <select name="telepon_kabel" id="telepon_kabel" class="form-control selectpicker"
                                    required>
                                    <option value="" disabled selected>--Pilih Status Telepon Kabel--</option>
                                    @foreach ($telepon_kabel as $val)
                                        @if ($val == old('telepon_kabel', $data->telepon_kabel))
                                            <option value="{{ $val }}" selected>{{ $val }}</option>
                                        @else
                                            <option value="{{ $val }}">{{ $val }}</option>
                                        @endif
                            ...
                            <div class="form-group">
                                ...
                                <select name="radio_komunikasi" id="radio_komunikasi" class="form-control selectpicker"
                                    required>
                                    <option value="" disabled selected>--Pilih Status Radio Komunikasi--</option>
                                    @foreach ($radio_komunikasi as $val)
                                        @if ($val == old('radio_komunikasi', $data->radio_komunikasi))
                                            <option value="{{ $val }}" selected>{{ $val }}</option>
                                        @else
                                            <option value="{{ $val }}">{{ $val }}</option>
                                        @endif
                            ...
                            <div class="form-group">
                                ...
                                <select name="jaringan_internet" id="jaringan_internet" class="form-control selectpicker"
                                    required>
                                    <option value="" disabled selected>--Pilih Status Jaringan Internet--</option>
                                    @foreach ($jaringan_internet as $val)
                                        @if ($val == old('jaringan_internet', $data->jaringan_internet))
                                            <option value="{{ $val }}" selected>{{ $val }}</option>
                                        @else
                                            <option value="{{ $val }}">{{ $val }}</option>
                                        @endif
                        ...
                        <div class="col-lg-4 mt-4 mt-lg-0 devide-right">
                            ...
                            <input type="hidden" id="sumber_listrik">
                            @foreach ($sumber_listrik as $val)
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="sumber_listrik"
                                        ...
                                        @if (old('sumber_listrik', $data->sumber_listrik) == $val) checked @endif required>
                        ...
                        <div class="col-lg-4 mt-4 mt-lg-0">
                            ...
                            <input type="hidden" id="akses_jalan_depan">
                            @foreach ($akses_jalan_depan as $val)
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="akses_jalan_depan"
                                        ...
                                        @if (old('akses_jalan_depan', $data->akses_jalan_depan) == $val) checked @endif required>
                            ...
                            <input type="hidden" id="kendaraan_lewat">
                            @foreach ($kendaraan_lewat as $val)
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="kendaraan_lewat"
                                        ...
                                        @if (old('kendaraan_lewat', $data->kendaraan_lewat) == $val) checked @endif required>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-3">
                                    <input type="number"
                                        ...
                                        id="waktu_tempuh" name="waktu_tempuh"
                                        value="{{ old('waktu_tempuh', $data->waktu_tempuh) }}" required>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row" id="pengolah-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-3">
                                    <input type="number"
                                        ...
                                        value="{{ old('komputer_berfungsi', $data->komputer_berfungsi) }}" required>
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-3">
                                    <input type="number"
                                        ...
                                        value="{{ old('komputer_tidak_berfungsi', $data->komputer_tidak_berfungsi) }}"
                                        required>
                                </div>
                            </div>
                            <hr class="line">
                            <div class="row mb-3">
                                ...
                                <div class="col-3">
                                    <input type="number"
                                        ...
                                        id="jml_komputer" name="jml_komputer"
                                        value="{{ old('jml_komputer', $data->jml_komputer) }}" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 mt-4 mt-lg-0">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-3">
                                    <input type="number"
                                        ...
                                        value="{{ old('laptop_berfungsi', $data->laptop_berfungsi) }}" required>
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-3">
                                    <input type="number"
                                        ...
                                        value="{{ old('laptop_tidak_berfungsi', $data->laptop_tidak_berfungsi) }}"
                                        required>
                                </div>
                            </div>
                            <hr class="line">
                            <div class="row mb-3">
                                ...
                                <div class="col-3">
                                    <input type="number" class="form-control @error('jml_laptop') is-invalid @enderror"
                                        id="jml_laptop" name="jml_laptop"
                                        value="{{ old('jml_laptop', $data->jml_laptop) }}" required>
                                </div>
                            </div>
                        </div>
                    </div>
