                        ...
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-sm btn-info text-white"
                                    href="{{ route('dashboard.spm.yearly.show', $val->slug) }}"
                                    data-bs-tooltip="tooltip" data-bs-placement="bottom" title="Lihat!">
                                    <i class="fas fa-eye"></i>
                                </a>
                                <a class="btn btn-sm btn-warning text-white"
                                    href="{{ route('dashboard.spm.yearly.edit', $val->slug) }}"
                                    data-bs-tooltip="tooltip" data-bs-placement="bottom" title="Ubah!">
                                    <i class="fas fa-edit"></i>
                                </a>
                                <button class="btn btn-sm btn-danger hapus-data" data-type="data_tahunan"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>
                    Apakah anda yakin akan menghapus data tahunan tahun <span class="tahun"></span>?
                </p>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Tutup</button>
                <form action="/dashboard/spm/data_tahunan/hapus" method="post">
                    @csrf
                    @method('delete')
