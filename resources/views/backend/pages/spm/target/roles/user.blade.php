                        ...
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-sm btn-info text-white"
                                    href="{{ route('dashboard.spm.target.show', $val->slug) }}" data-bs-tooltip="tooltip"
                                    data-bs-placement="bottom" title="Lihat!">
                                    <i class="fas fa-eye"></i>
                                </a>
                                <a class="btn btn-sm btn-warning text-white"
                                    href="{{ route('dashboard.spm.target.edit', $val->slug) }}" data-bs-tooltip="tooltip"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <form action="/dashboard/spm/data_sasaran/hapus" method="post">
                    @csrf
                    @method('delete')
